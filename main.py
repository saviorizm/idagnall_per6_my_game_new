...
class Game:
    ...
    def new(self):
        ...
        self.plat1 = Platform(WIDTH,200,0,WIDTH-200,WHITE, "normal")
        self.all_sprites.add(self.player)
        # self.all_sprites.add(self.player_left)
        # self.all_sprites.add(self.player_right)
        # self.all_sprites.add(self.player_top)
        # self.all_sprites.add(self.player_bottom)
